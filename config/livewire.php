...
return [
    ...
    */
    ...
    'class_namespace' => 'Phunky\\Livewire',
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // Must allow at least the largest `max:` in config/messaging.php media_attachment_types (image/video use 51200 KB).
        'rules' => ['required', 'file', 'max:51200'],
        'directory' => null,                                  // Example: 'tmp'                     | Default: 'livewire-tmp'
        'middleware' => null,                                 // Example: 'throttle:5,1'            | Default: 'throttle:60,1'
        'preview_mimes' => [                                  // Extensions allowed for Livewire temporaryUrl() previews...
            'png', 'gif', 'bmp', 'svg', 'wav', 'mp4',
            'mov', 'avi', 'wmv', 'mp3', 'm4a', 'webm',
            'jpg', 'jpeg', 'mpga', 'webp', 'wma', 'ogg', 'weba',
            'm4v', 'mkv', '3gp', '3g2', 'ogv', 'mpeg', 'mpg',
        ],
    ...
    */
    ...
    'payload' => [
        ...
        'max_components' => 250,     // Maximum components per batch request (chat lists many rows)
    ],
];
